...
const PhoneLines = () => {
  ...
  return (
    <div className="w-full flex h-full">
      <section className="w-2/5 bg-white dark:bg-mcm-surface">
        <div className="m-auto h-full flex flex-col gap-16 items-center justify-center">
          <form className="flex flex-col pb-8 p-8 bg-white dark:bg-mcm-surface gap-3">
            <h3 className="text-2xl font-semibold">Choose a main number for your account</h3>
            <div className={`flex flex-col border border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface-3 backdrop-blur-[12px] rounded-xl p-3 gap-2`}>
        ...
        <div className="p-8 flex flex-col gap-4  w-full  m-auto">
          ...
          <div className="w-full flex items-center gap-3">
            <div className="flex  flex-col gap-4 w-full">
              {isShowTable ? (
                <div className="w-full relative bg-white dark:bg-mcm-surface rounded-xl p-3">
                    ...
                    <div className="flex flex-wrap mx-auto w-full gap-5">
                      {watchCity?.value && watchRegion?.value ? (
                        isPendingAvailableDID || isFetchingAvailableDID ? (
                          ...
                          <div className="bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface-3 backdrop-blur-[12px] w-full border border-[rgba(225,200,165,0.9)] dark:border-mcm-line rounded-xl p-3 gap-3 flex flex-col">
                          ...
                          <div>
                            <div className="bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface-3 backdrop-blur-[12px] border border-[rgba(225,200,165,0.9)] dark:border-mcm-line rounded-xl p-3 gap-3 flex flex-col items-center">
                              <div className="pb-1 flex flex-col gap-0.5 px-3">
                        ...
                        <div className="rounded-lg m-auto border border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface-3 backdrop-blur-[12px] p-3 text-center">
                          <h5 className="text-base text-[#2E2D35] dark:text-mcm-ink font-normal w-full text-center flex justify-center">
