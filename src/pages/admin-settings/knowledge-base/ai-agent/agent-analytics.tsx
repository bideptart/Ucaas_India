...
const KpiCard = ({
  ...
  <div className="relative flex min-h-[86px] flex-col justify-between rounded-[10px] border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] px-4 py-3.5 shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
...
export default function AgentAnalytics({ onClose, agents = [] }: AgentAnalyticsProps) {
  ...
  if (ANALYTICS_COMING_SOON) {
    ...
    return (
      <div className="flex h-full min-h-0 w-full flex-col overflow-hidden bg-[#f3f4f6] text-[#07142f] dark:text-mcm-ink">
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col overflow-hidden bg-[#f3f4f6] text-[#07142f] dark:text-mcm-ink">
      ...
      <div className="flex min-h-[64px] shrink-0 flex-col gap-3 border-b border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] px-4 py-3 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 lg:justify-end">
          ...
          <Button
            ...
            className="h-9 gap-1.5 border-[#EEE7DD] dark:border-mcm-line px-3 text-xs font-semibold text-slate-700 hover:border-[rgba(225,200,165,0.9)] dark:hover:border-mcm-line/90 hover:bg-white hover:text-slate-900"
          >
      ...
      >
        ...
        {selectedRepId !== 'all' ? null : (
          <div className="relative mb-[14px] rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] p-[22px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
            {isLoading && <CardLoader />}
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="rounded-full border border-[#EEE7DD] dark:border-mcm-line bg-slate-50 px-3 py-1 text-xs font-medium text-slate-700">
                All agents
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 gap-[14px] lg:grid-cols-3">
          <div className="relative rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] p-[22px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)] lg:col-span-2">
            {isLoading && <CardLoader />}
                    ...
                    <button
                      ...
                      className={`rounded-full px-3 py-1 transition-colors ${
                        isActive
                          ...
                          : 'border border-[#EEE7DD] dark:border-mcm-line bg-white text-slate-600 hover:border-[rgba(225,200,165,0.9)] dark:hover:border-mcm-line/90 hover:text-slate-900'
                      }`}
          ...
          <div className="relative rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] p-[22px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
            {isLoading && <CardLoader />}
        ...
        <div className="grid grid-cols-1 gap-[14px] lg:grid-cols-2">
          ...
          <div className="relative flex flex-col rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] p-[22px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
            {isLoading && <CardLoader />}
        ...
        {/* Agent performance */}
        <div className="relative rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
          {isLoading && <CardLoader />}
              ...
              <button
                ...
                className={`rounded-full px-3 py-1 text-xs font-semibold transition-all ${
                  performancePeriod === '7d'
                    ...
                    : 'bg-white border border-[#EEE7DD] dark:border-mcm-line text-slate-500 hover:bg-slate-50'
                }`}
              >
                Last 7 days
              </button>
        ...
        <div className="grid grid-cols-1 gap-[14px] lg:grid-cols-3">
          ...
          <div className="relative flex flex-col justify-between rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] p-[22px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
            {isLoading && <CardLoader />}
            <div>
            ...
            <div className="mt-6 text-xs">
              {countries.map((c: any, i: any) => (
                ...
                >
                  ...
                  <div className="relative h-[5px] w-[60px] shrink-0 overflow-hidden rounded-[3px] bg-[#FBE2C8]/40 dark:bg-mcm-surface-3/40">
                    <div
        ...
        <div className="grid grid-cols-1 gap-[14px] lg:grid-cols-3">
          ...
          <div className="relative max-h-[360px] overflow-y-auto rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line/90 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface/88 backdrop-blur-[12px] p-[22px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)]">
            {isLoading && <CardLoader />}
