...
export const Messages = ({
  ...
  return (
    <div
      ...
      className={`chatInnerSec relative w-full h-full min-h-0 overflow-y-auto overflow-x-hidden flex-1 ${isAgentChat ? 'bg-ucass-gray' : 'bg-gray-100 dark:bg-mcm-ground'} ${
            ...
            <div className="w-full flex flex-col" key={messageId || `msg-${index}`}>
              {showDateSeparator && currentDate.isValid() ? (
                <div className="flex items-center justify-center my-4 mx-auto w-[25%]">
                  <p className="bg-[#F0DFC5] dark:bg-[#1a2733] rounded-full px-4 text-xs py-1">
...
export const ChatHeader = ({
    ...
    joinedParticipants.length > 0 ? (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            type="button"
            className="h-8 px-2 rounded-lg border border-[#EEE7DD] dark:border-mcm-line text-[#9A948F] dark:text-mcm-ink-3 hover:bg-[#FBE2C8]/45 dark:hover:bg-[#1a2733]/45 flex items-center gap-1"
        ...
        <DropdownMenuContent align="end" className="min-w-[230px] bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] border border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)]">
          <div className="px-2 py-1.5 text-[11px] uppercase tracking-wide text-[#9A948F] dark:text-mcm-ink-3 border-b border-gray-100 dark:border-mcm-line">
            Live Participants
          </div>
    ...
    if (isAmOnCall) {
      return (
        <CustomTooltip text={'You are currently on another call'} side="top">
          <button
            className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors duration-200 font-medium text-sm text-[#9A948F] dark:text-mcm-ink-3 bg-[#FBE2C8]/40 dark:bg-[#1a2733]/40 cursor-not-allowed`}
          >
            On Call
          </button>
        </CustomTooltip>
    ...
    return (
      ...
      >
        ...
        <div className="absolute right-0 top-full pt-1 opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto transition-all duration-150 origin-top-right z-50">
          <div className="min-w-[220px] bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] border border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)] rounded-lg p-1 shadow-md">
            <div className="px-2 py-1.5 text-[10px] uppercase tracking-wide text-[#9A948F] dark:text-mcm-ink-3 border-b border-gray-100 dark:border-mcm-line select-none">
              Select Call Type
            </div>
            <CustomTooltip text={audioBlockReason || 'Start voice call'} side="right">
              <span className="block">
                <button
                  ...
                  className="w-full flex items-center gap-2 mt-1 px-2 py-2 text-xs text-left rounded-md hover:bg-[#FBE2C8]/40 dark:hover:bg-[#1a2733]/40 disabled:pointer-events-none disabled:opacity-50 cursor-pointer text-[#2E2D35] dark:text-mcm-ink transition-colors"
                >
            ...
            <CustomTooltip text={videoBlockReason || 'Start video call'} side="right">
              <span className="block">
                <button
                  ...
                  className="w-full flex items-center gap-2 px-2 py-2 text-xs text-left rounded-md hover:bg-[#FBE2C8]/40 dark:hover:bg-[#1a2733]/40 disabled:pointer-events-none disabled:opacity-50 cursor-pointer text-[#2E2D35] dark:text-mcm-ink transition-colors"
                >
  ...
  return (
    <>
      ...
      <div className="w-full min-h-16 shrink-0 border-b border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)] px-3 sm:px-4 flex items-center justify-between bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] gap-2 sm:gap-3">
        <div className="flex items-center gap-3 min-w-0 ">
          {onBackToList ? (
            <button
              type="button"
              className="xl:hidden w-9 h-9 rounded-full flex items-center justify-center bg-[#FBE2C8]/40 dark:bg-[#1a2733]/40 text-[#2E2D35] dark:text-mcm-ink hover:bg-[#F0DFC5] dark:hover:bg-[#1a2733] shrink-0 z-1"
          ...
          {showSearch ? (
            <div className="w-full flex items-center gap-2">
              ...
              <button
                type="button"
                className="w-8 h-8 rounded-md flex items-center justify-center hover:bg-[#FBE2C8]/40 dark:hover:bg-[#1a2733]/40 text-[#9A948F] dark:text-mcm-ink-3 shrink-0"
                onClick={resetSearch}
            ...
            <div className="flex min-w-0 max-w-[52vw] sm:max-w-[62vw] xl:max-w-full items-center gap-1 overflow-x-auto overflow-y-hidden md:overflow-visible sm:gap-2 scrollbar-hide">
              ...
              {!isMessageSelectionMode ? (
                <CustomTooltip text="Search" side="top">
                  <button
                    type="button"
                    className={`cursor-pointer shrink-0 flex items-center justify-center rounded-full w-9 h-9 bg-[#FBE2C8]/40 dark:bg-[#1a2733]/40 text-[#2E2D35]/80 dark:text-mcm-ink/80 hover:bg-ucass-active hover:text-white transition-colors duration-200
                   `}
      ...
      >
        <DialogContent className="bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] max-w-[540px]">
...
const AttachmentGlyph = ({
  ...
  const wrapperClass = large
    ? 'flex h-28 w-28 items-center justify-center rounded-2xl bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] text-gray-300 shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)] dark:shadow-[0_12px_28px_-6px_rgba(0,0,0,0.22),0_2px_8px_rgba(0,0,0,0.12)] ring-1 ring-[#EEE7DD] dark:ring-mcm-line'
    : 'flex h-full w-full items-center justify-center rounded-md bg-[#FBE2C8]/40 dark:bg-[#1a2733]/40 text-[#9A948F] dark:text-mcm-ink-3';
...
const AttachmentNoPreview = ({ item }: { item: any }) => {
  ...
  return (
    <div className="flex h-[min(420px,48vh)] w-[min(720px,calc(100vw-2rem))] flex-col items-center justify-center rounded-xl bg-[#eef1f5] dark:bg-mcm-surface-3 px-6 text-center">
      <AttachmentGlyph kind={item?.kind || 'file'} extension={item?.extension} large />
      <div className="mt-8 text-2xl font-normal text-[#aebbc7] dark:text-mcm-ink-3 sm:text-[30px]">
        No preview available
      </div>
      <div className="mt-2 text-sm font-semibold uppercase tracking-wide text-[#aebbc7] dark:text-mcm-ink-3 sm:text-base">
...
const AttachmentPreviewStage = ({
  ...
  if (item.kind === 'audio') {
    return (
      <div className="flex w-[min(520px,calc(100vw-2rem))] flex-col items-center rounded-xl bg-[#f4f5f7] dark:bg-mcm-surface-3 px-6 py-10 text-center">
...
const AttachmentThumbnail = ({
  ...
  return (
    <div
      ...
      className={cn(
        'group relative h-14 w-14 shrink-0 cursor-pointer rounded-lg border-2 bg-white dark:bg-mcm-surface p-0.5 transition-all',
        isActive
    ...
    >
      <div className="h-full w-full overflow-hidden rounded-md">
        {canShowMediaThumb ? (
          ...
          <div className="flex h-full w-full flex-col items-center justify-center gap-1 bg-[#FBE2C8]/45 dark:bg-[#1a2733]/45 px-1 text-[#9A948F] dark:text-mcm-ink-3">
...
export const ChatFooter = ({
    ...
    activeReplyMessage ? (
      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            className="w-6 h-6 rounded-full flex items-center justify-center text-[#9A948F] dark:text-mcm-ink-3 hover:bg-white/80 dark:hover:bg-mcm-surface-3"
  ...
  const baseComposerClasses =
    'w-full flex flex-col border-t-2 border-r border-l border-t-primary/70 focus-visible:border-t-primary focus-within:border-t-primary border-r-[#EEE7DD] dark:border-r-mcm-line border-l-[#EEE7DD] dark:border-l-mcm-line rounded-md shadow-sm min-h-[120px] pb-8 relative';
    ...
    <div
      ...
      className={cn(
        ...
        hasAttachmentPreview
          ? 'absolute inset-0 z-20 flex h-full min-h-0 w-full flex-col bg-[#edf1f6] dark:bg-mcm-ground'
          : `w-full shrink-0 bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] px-2 py-2 relative flex flex-col ${typingText ? 'gap-0' : 'gap-3'} border-t border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)]`,
    ...
    >
      {showAttachmentUploadOverlay ? (
        <div className="absolute inset-0 z-40 bg-ucass-active-bg/80 backdrop-blur-[2px] flex items-center justify-center px-3">
          <div className="relative w-full max-w-lg overflow-hidden rounded-xl border border-ucass-active-bg bg-white dark:bg-mcm-surface shadow-[0_14px_34px_rgba(15,23,42,0.14)]">
      ...
      {hasAttachmentPreview ? (
        <div className="flex h-full min-h-0 w-full flex-col bg-[#edf1f6] dark:bg-mcm-ground">
          <div className="flex h-11 shrink-0 items-center border-b border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)] bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] px-5">
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-md px-1 py-1 text-sm font-medium text-[#26364d] dark:text-mcm-ink transition-colors hover:text-primary"
          ...
          <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-4 pb-4 pt-5 sm:px-8">
            ...
            {attachmentPreviewMeta ? (
              <div className="mt-4 max-w-[min(720px,calc(100vw-2rem))] truncate text-center text-xs font-medium text-[#1d2940] dark:text-mcm-ink-2">
                {attachmentPreviewMeta}
              </div>
            ) : null}
            ...
            <div className="mt-3 w-full max-w-[680px]">
              ...
              <div className="relative min-h-12 rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)] bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] px-11 py-2 shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)] dark:shadow-[0_12px_28px_-6px_rgba(0,0,0,0.22),0_2px_8px_rgba(0,0,0,0.12)] [&_[data-test-id=menu]]:hidden">
                <div className="absolute left-4 top-1/2 z-10 -translate-y-1/2 text-[#8a97ad] dark:text-mcm-ink-3">
          ...
          <div className="relative flex min-h-[86px] shrink-0 items-center px-5 pb-5 pt-2">
            ...
            <div className="flex max-w-full flex-1 items-center justify-start gap-3 overflow-x-auto pr-32 scrollbar-hide sm:pr-4 pt-2">
              ...
              <button
                type="button"
                className={cn(
                  'flex h-14 w-14 shrink-0 items-center justify-center rounded-lg border border-dashed border-[#b9c4d6] dark:border-mcm-line bg-white/30 dark:bg-mcm-surface-3 text-[#73839c] dark:text-mcm-ink-3 transition-colors hover:border-ucass-active hover:bg-white dark:hover:bg-mcm-surface hover:text-ucass-active',
            ...
            <div className="flex items-center gap-4">
              <span className="whitespace-nowrap text-xs font-medium text-[#71809a] dark:text-mcm-ink-3">
        ...
        <>
          ...
          {isRecording && !fromMeetChat && !isGuestRestrictedFooter && canUseFileUploadControls ? (
            <div className="min-h-[150px] flex items-center justify-center border-t-2 border-ucass-active/70 border-r border-l border-r-[#EEE7DD] dark:border-r-mcm-line border-l-[#EEE7DD] dark:border-l-mcm-line rounded-md shadow-sm">
              ...
              <div className="absolute right-0 bottom-1 z-[12]">
                <div className="flex gap-1.5 items-center px-2  pointer-events-auto rounded-full">
                  ...
                  {showAiAssistTrigger ? (
                    hasAiAssistAgent ? (
                      ...
                      <Popover>
                        ...
                        <PopoverContent
                          className="w-[calc(100vw-2rem)] max-w-80 p-0 overflow-hidden rounded-xl border border-[rgba(225,200,165,0.72)] dark:border-[rgba(71,85,105,0.72)] shadow-xl"
                          side="top"
                        >
                  ...
                  <button
                    type="button"
                    className={cn(
                      'min-w-7 max-h-7 max-w-7 min-h-7 flex justify-center items-center text-ucass-active border-l border-[#EEE7DD] dark:border-mcm-line pl-2 transition-colors',
                      !canSend || isComposerBusy
...
const ThreadPanel = ({
  ...
  return (
    <div
      className={`relative bg-white dark:bg-mcm-ground flex flex-col w-full h-full min-h-0 ${fromMeetChat ? 'min-w-0' : ''}`}
    >
      ...
      <div className="w-full shrink-0 px-4 bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] flex items-center justify-between border-b min-h-[56px] lg:min-h-[65px] border-b-[rgba(225,200,165,0.9)] dark:border-b-[rgba(71,85,105,0.9)]">
      ...
      <div className="p-3 overflow-y-auto overflow-x-hidden flex-1 ">
        ...
        <div className="w-full max-w-44 mx-auto relative h-[1px] bg-[#F0DFC5] dark:bg-[#1a2733] flex justify-center items-center my-6">
          <div className="bg-[#FBE2C8]/40 dark:bg-[#1a2733]/40 px-3 py-1 absolute -top-3 text-[#9A948F] dark:text-mcm-ink-3 text-xs rounded-full border">
...
const AddMemberDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px]">
        <DialogHeader>
      ...
      {isLoading ? (
        ...
        <div className="flex-1 w-full bg-[var(--color-bg-gray-50)] p-3 flex items-center justify-center min-h-0 overflow-hidden">
          <div className="flex flex-col justify-center items-center gap-2 py-5 h-full w-full mx-auto">
            <div className="w-16 h-16 rounded-full bg-[#FBE2C8]/40 dark:bg-[#1a2733]/40 flex items-center justify-center mb-2">
        ...
        <div className="flex-1 w-full bg-white dark:bg-mcm-ground lg:bg-[var(--color-bg-gray-50)] p-4 flex flex-col min-h-0 overflow-hidden">
...
const MembersView = ({ currentChat, onClose }: { currentChat: any; onClose: () => void }) => {
  ...
  return (
    <div className="w-full flex flex-col h-full bg-[var(--color-bg-gray-50)] overflow-hidden">
      ...
      <div className="flex-1 w-full bg-white dark:bg-mcm-ground lg:bg-[var(--color-bg-gray-50)] p-4 flex flex-col overflow-hidden min-h-0">
        <div className="flex-1 overflow-y-auto pr-2 pb-2">
            ...
            {members.map((member: any, index: number) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    'flex flex-col gap-2 p-3 rounded-lg border transition-all bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)] dark:shadow-[0_12px_28px_-6px_rgba(0,0,0,0.22),0_2px_8px_rgba(0,0,0,0.12)]',
                    isSelectMode && canBeRemoved ? 'cursor-pointer' : '',
                    isSelected
                      ? 'border-primary bg-primary/5 ring-1 ring-primary/20'
                      : 'border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)] hover:bg-[#FBE2C8]/45 dark:hover:bg-[#1a2733]/45',
                  )}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {memberRoleLabel && !isSelectMode && (
                      <span className="text-[10px] font-semibold bg-gray-100 text-gray-600 dark:bg-mcm-surface-3 dark:text-mcm-ink-3 px-2 py-1 rounded-full uppercase tracking-wider">
                        {memberRoleLabel}
                      </span>
                    )}
                  ...
                  {isAdmin &&
                    ...
                    !isSelectMode && (
                      <div className="flex gap-2 pt-2 border-t border-gray-100 dark:border-mcm-line mt-1">
                        <button
                          type="button"
...
const ChatWorkspace = ({
  ...
  return (
    <div className={`w-full h-full min-h-0 flex flex-col overflow-hidden bg-white dark:bg-mcm-ground`}>
      ...
      >
        {isAuxSidebarOpen ? null : (
          <div className="relative flex-1 min-w-0 min-h-0 flex flex-col bg-white dark:bg-mcm-ground">
            <MessagesComponent
              currentChat={currentChat}
              typingText={typingText}
              disableScrollTop={disableScrollTop}
            ...
            {hideFooter ? null : currentChat && currentChat?.isEnded ? (
              <div className="w-full shrink-0 border-t border-[#EEE7DD] dark:border-mcm-line bg-[#FBE2C8]/45 dark:bg-[#1a2733]/45 px-4 py-3 flex items-center justify-center gap-2">
        ...
        {createTaskMsgObj && (
          ...
          >
            <DialogContent className="flex max-h-[90vh] w-[calc(100vw-1rem)] max-w-[680px] flex-col overflow-hidden bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.88)] backdrop-blur-[12px] p-4 sm:max-w-2xl sm:p-6">
