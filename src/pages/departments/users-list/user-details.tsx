...
const UserDetails: FC = () => {
  ...
  const actions = [
    userAccess?.is_chat && {
      ...
      className:
        'cursor-pointer flex items-center justify-center rounded-full w-9 h-9 bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#2E2D35]/80 dark:text-mcm-ink/80 hover:bg-primary hover:text-white',
      tooltipText: 'Chat',
      access: !isSelf,
    },
    IS_ADMIN &&
    ...
    userAccess?.is_call && {
      ...
      className: `${iamOnCall ? 'bg-[#F0DFC5] dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 cursor-not-allowed' : 'bg-green-100 text-green-500 hover:bg-green-400 hover:text-white cursor-pointer'}  flex items-center justify-center rounded-full w-9 h-9`,
      tooltipText: 'Call',
    ...
    userAccess?.delete && {
      ...
      ${
        isSelf
          ? 'bg-[#F0DFC5] dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 cursor-not-allowed'
    ...
    <section className="w-full min-w-0 flex flex-col overflow-hidden gap-3 h-full">
      {isLoading ? (
        ...
        <div className="w-full h-full">
          <div className="w-full min-w-0 px-3 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface-3 backdrop-blur-[12px] gap-2 flex items-center justify-between rounded-none border-b border-[rgba(225,200,165,0.9)] dark:border-mcm-line min-h-[65px] ">
            ...
            <div className="flex min-w-0 items-center justify-between w-[calc(100%_-_3rem)]">
              <div className="flex min-w-0 flex-col">
                <p className="font-semibold text-[#2E2D35] dark:text-mcm-ink truncate text-md">
                ...
                {actions
                  ...
                  .map((action: any, index: number) => (
                    <CustomTooltip key={index} text={action.tooltipText} side="top">
                      <div
                        className={cn(
                          'cursor-pointer flex items-center justify-center rounded-xl w-8 h-8 bg-card ',
                          action.className,
                        )}
          ...
          <div className="p-3 gap-6 flex w-full flex-col h-[calc(100vh-11rem)] md:h-[calc(100vh-8rem)] overflow-y-auto max-w-full xl:max-w-[80%] mx-auto">
            <div className="flex flex-col gap-4 p-4 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface-3 backdrop-blur-[12px] rounded-lg border border-[rgba(225,200,165,0.9)] dark:border-mcm-line">
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex flex-col gap-1.5 w-full">
                  <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'First Name'}</p>
                  <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
                    {capitalizeFirstLetter(tabData?.first_name) || 'NA'}
                  </p>
                </div>
                <div className="flex flex-col gap-1.5 w-full">
                  <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'Last Name'}</p>
                  <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex flex-col gap-1.5 w-full">
                  <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'Email'}</p>
                  <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
                    {tabData?.email}
                  </p>
                </div>
                <div className="flex flex-col gap-1.5 w-full">
                  <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'Phone'}</p>
                  <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex flex-col gap-1.5 w-full">
                  <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'Site'}</p>
                  <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
                    {tabData?.site?.name ?? 'NA'}
                  </p>
                </div>
                <div className="flex flex-col gap-1.5 w-full">
                  <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'Extension'}</p>
                  <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
              ...
              {tabData?.caller_id ? (
                <div className="flex flex-col gap-4 sm:flex-row">
                  <div className="flex flex-col gap-1.5 w-full">
                    <p className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">{'Caller ID'}</p>
                    <p className="bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3 px-3 min-h-10 flex items-center break-all text-sm rounded-xl">
            ...
            {/* <ul
              role="list"
              className="divide-y divide-grey-200 flex flex-col gap-8 p-5 bg-card rounded-xl border border-border"
            >
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm">{'First Name'}</p>
                <p className="text-[#2E2D35] font-medium text-sm">
                  {capitalizeFirstLetter(tabData?.first_name) || 'NA'}
                </p>
              </li>
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm">{'Last Name'}</p>
                <p className="text-[#2E2D35] font-medium text-sm">
                  {capitalizeFirstLetter(tabData?.last_name) || 'NA'}
                </p>
              </li>
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm">{'Email'}</p>
                <p className="text-[#2E2D35] font-medium text-sm">{tabData?.email}</p>
              </li>
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm"> {'Phone'}</p>
                <p className="text-[#2E2D35] font-medium text-sm">
                  {tabData?.phone?.startsWith('+') ? tabData?.phone : `+${tabData?.phone}`}
                </p>
              </li>
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm"> {'Site'}</p>
                <p className="text-[#2E2D35] font-medium text-sm">{tabData?.site?.name ?? 'NA'}</p>
              </li>
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm">{'Extension'}</p>
                <p className="text-[#2E2D35] font-medium text-sm">{tabData?.extension ?? 'NA'}</p>
              </li>
              <li className="py-3 flex justify-between first:pt-0">
                <p className="text-muted-foreground font-normal text-sm">{'Caller ID'}</p>
                {tabData?.caller_id ? (
