...
const ParticipantChat = ({
  ...
  return (
    <div className="bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.92)] backdrop-blur-[12px] rounded-xl absolute right-8 bottom-20 m-auto flex h-[min(34rem,calc(100dvh-7.5rem))] min-h-[22rem] max-h-[calc(100dvh-7.5rem)] flex-col w-[400px] overflow-hidden shadow-lg border border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)]">
