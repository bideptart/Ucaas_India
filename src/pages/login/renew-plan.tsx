    ...
    return (
      <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-white to-primary/5 flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          <p className="text-gray-600 dark:text-mcm-ink-3 font-medium">
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-white to-primary/5 flex items-center justify-center p-6">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white dark:bg-mcm-surface rounded-2xl shadow-lg shadow-gray-200/80 border border-gray-100 dark:border-mcm-line overflow-hidden">
          {/* Current Plan */}
          <div className="p-6 sm:p-8 border-b border-gray-100 dark:border-mcm-line">
            ...
            <div className="mt-5 rounded-xl bg-gray-50/80 dark:bg-mcm-surface-3/80 border border-gray-100 dark:border-mcm-line p-4">
              <p className="text-sm font-medium text-gray-600 dark:text-mcm-ink-3">
                Last billing for{' '}
                {userInfoData?.company_info?.is_trial === 'Y'
                  ? 1
