...
const InboxDetail = ({ inboxId, assistants, onBack }: { inboxId: string; assistants: any[]; onBack: () => void }) => {
  ...
  if (isLoading || !inbox) {
    return <div className="flex h-40 items-center justify-center text-sm text-[#9A948F] dark:text-mcm-ink-3">Loading...</div>;
  }
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col gap-5 p-6">
      <div className="flex flex-col gap-1">
        <button type="button" onClick={onBack} className="flex w-fit items-center gap-1 text-xs font-medium text-[#9A948F] dark:text-mcm-ink-3 hover:text-[#2E2D35] dark:hover:text-mcm-ink">
          <ChevronLeft className="size-3.5" />
          Inboxes
        </button>
        <div className="flex items-center justify-between gap-3">
          <h2 className="text-lg font-bold text-[#2E2D35] dark:text-mcm-ink">{inbox.name}</h2>
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 lg:grid-cols-[1fr_320px]">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex min-h-0 flex-col gap-4">
          <TabsList className="h-auto w-full flex-wrap justify-start gap-5 rounded-none border-b border-[#EEE7DD] dark:border-mcm-line bg-transparent p-0">
            {TABS.map((t) => (
              <TabsTrigger
                key={t.key}
                value={t.key}
                className="rounded-none border-b-2 border-transparent bg-transparent px-0.5 pb-2.5 text-sm font-medium text-[#9A948F] dark:text-mcm-ink-3 shadow-none data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-[#2E2D35] dark:data-[state=active]:text-mcm-ink data-[state=active]:shadow-none"
              >
                {t.label}
              </TabsTrigger>
            ))}
          ...
          <TabsContent value="settings" className="flex flex-col gap-5 pt-4">
                ...
                {([
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 rounded-xl border px-4 py-3 text-left transition-colors ${selected ? 'border-primary bg-primary/5' : 'border-[#EEE7DD] dark:border-mcm-line hover:border-[#EEE7DD] dark:hover:border-mcm-line'}`}
                    >
                      <div className="flex items-center gap-2">
                        <span className={`flex size-4 shrink-0 items-center justify-center rounded-full border-2 ${selected ? 'border-primary' : 'border-[#EEE7DD] dark:border-mcm-line'}`}>
                          {selected && <span className="size-2 rounded-full bg-primary" />}
                        </span>
                        <span className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">{opt.title}</span>
                      </div>
                      <div className="mt-1 pl-6 text-xs text-[#9A948F] dark:text-mcm-ink-3">{opt.desc}</div>
                    </button>
                  );
                })}
              </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] px-3 py-2.5 text-sm text-[#2E2D35] dark:text-mcm-ink shadow-[0_12px_28px_-6px_rgba(194,98,46,0.22),0_2px_8px_rgba(194,98,46,0.12)] dark:shadow-[0_12px_28px_-6px_rgba(0,0,0,0.35),0_2px_8px_rgba(0,0,0,0.25)] outline-none focus:border-primary focus:ring-4 focus:ring-primary/10"
              />
            </div>
            <div className="flex gap-4">
              <div className="flex flex-1 flex-col gap-1.5">
                <Label>Widget Color</Label>
                <input type="color" value={inbox.widget_color} onChange={(e) => patch({ widget_color: e.target.value })} className="h-10 w-full cursor-pointer rounded-xl border border-[#EEE7DD] dark:border-mcm-line" />
              </div>
              <div className="flex flex-1 flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-2 rounded-xl border border-[#EEE7DD] dark:border-mcm-line bg-[#FBE2C8]/50 dark:bg-mcm-surface-3 p-3">
                {[
                  ...
                  <div key={f.key} className="flex items-center gap-2.5">
                    ...
                    />
                    <Label htmlFor={f.key} className="cursor-pointer text-sm font-normal text-[#2E2D35] dark:text-mcm-ink">{f.label}</Label>
                  </div>
                ))}
              </div>
            </div>
            <div className="flex flex-col gap-2 rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              ...
              <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Auto-greet visitors when they start a conversation and send their first message.</p>
            ...
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                <Label>Enable email collect box</Label>
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Enable or disable email collect box on new conversation.</p>
              </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                ...
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Allow the end-user to send messages even after the conversation is resolved.</p>
              </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                ...
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Conversations will continue over email if the contact's email address is available.</p>
              </div>
          ...
          <TabsContent value="collaborators" className="flex flex-col gap-4 pt-4">
            <Label>Agents</Label>
            <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Add or remove agents from this inbox. Leave empty to allow every agent.</p>
            ...
            <div className="flex max-h-64 flex-col gap-1 overflow-y-auto rounded-xl border border-[#EEE7DD] dark:border-mcm-line">
              {filteredTeamMembers.length === 0 ? (
                <div className="px-4 py-6 text-center text-xs text-[#9A948F] dark:text-mcm-ink-3">No team members found.</div>
              ) : (
                filteredTeamMembers.map((m) => (
                  <label key={m.uuid} className="flex cursor-pointer items-center gap-2.5 border-b border-gray-50 px-4 py-2.5 last:border-0 hover:bg-[#FBE2C8]/45 dark:hover:bg-mcm-surface-3">
                    <Checkbox checked={selectedAgents.has(m.uuid)} onCheckedChange={() => toggleAgent(m.uuid)} />
                    <div className="min-w-0">
                      <div className="truncate text-sm text-[#2E2D35] dark:text-mcm-ink">{m.name}</div>
                      <div className="truncate text-xs text-[#9A948F] dark:text-mcm-ink-3">{m.email}</div>
                    </div>
                  </label>
                ))
              )}
            ...
            <div className="mt-4 flex flex-col gap-3 border-t border-gray-100 dark:border-mcm-line pt-4">
              <Label>Conversation Assignment</Label>
              <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
                <div>
                  <div className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">Enable automatic conversation assignment</div>
                  <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Automatically assign incoming conversations to available agents.</p>
                </div>
                <Switch
          ...
          <TabsContent value="business-hours" className="flex flex-col gap-4 pt-4">
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                <div className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">Enable business availability for this inbox</div>
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Shows available hours on the widget even when all agents are offline.</p>
              </div>
            ...
            <div className="flex flex-col divide-y divide-gray-100 dark:divide-mcm-line rounded-xl border border-[#EEE7DD] dark:border-mcm-line">
              {DAY_ORDER.map((d) => {
                ...
                return (
                  <div key={d.key} className="flex flex-wrap items-center gap-3 px-4 py-2.5 text-sm">
                    ...
                    />
                    <span className="w-24 text-[#2E2D35] dark:text-mcm-ink">{d.label}</span>
                    {sched.enabled ? (
                      <>
                        <input type="time" value={sched.open} onChange={(e) => patch({ business_hours: { ...inbox.business_hours, [d.key]: { ...sched, open: e.target.value } } })} className="rounded-lg border border-[#EEE7DD] dark:border-mcm-line px-2 py-1 text-xs" />
                        <span className="text-[#9A948F] dark:text-mcm-ink-3">—</span>
                        <input type="time" value={sched.close} onChange={(e) => patch({ business_hours: { ...inbox.business_hours, [d.key]: { ...sched, close: e.target.value } } })} className="rounded-lg border border-[#EEE7DD] dark:border-mcm-line px-2 py-1 text-xs" />
                        <span className="ml-auto rounded-full bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 px-2 py-0.5 text-[10px] text-[#9A948F] dark:text-mcm-ink-3">{hoursBetween(sched.open, sched.close)}</span>
                      </>
                    ) : (
                      <span className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Unavailable</span>
                    )}
                  </div>
                );
              })}
          ...
          <TabsContent value="csat" className="flex flex-col gap-4 pt-4">
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                <div className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">Enable CSAT</div>
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Automatically trigger CSAT surveys at the end of conversations.</p>
              </div>
              ...
              <div className="flex gap-3">
                {(['emoji', 'star'] as const).map((opt) => (
                  <button
                    ...
                    className={`rounded-xl border px-4 py-2 text-sm ${inbox.csat_display_type === opt ? 'border-primary bg-primary/5' : 'border-[#EEE7DD] dark:border-mcm-line'}`}
                  >
                    {opt === 'emoji' ? '😡 😕 😐 🙂 😍' : '★ ★ ★ ★ ★'}
                  </button>
                ))}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              />
              <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Leave blank to send the survey on every resolved conversation.</p>
            </div>
            <Button
              type="button"
              variant="primary"
          ...
          <TabsContent value="pre-chat-form" className="flex flex-col gap-4 pt-4">
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                <div className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">Enable pre chat form</div>
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Capture visitor information before they start a conversation.</p>
              </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              {inbox.pre_chat_fields.map((f, i) => (
                <div key={f.name} className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-50 pb-2 last:border-0 last:pb-0">
                  <span className="w-28 text-sm text-[#2E2D35] dark:text-mcm-ink">{f.label}</span>
                  <Input
                    type="text"
                    value={f.label}
                    onChange={(e) => {
                    ...
                    className="w-40"
                  />
                  <label className="flex items-center gap-1.5 text-xs text-[#9A948F] dark:text-mcm-ink-3">
                    <Checkbox
                      checked={f.enabled}
                      onCheckedChange={(c) => {
                        const fields = [...inbox.pre_chat_fields];
          ...
          <TabsContent value="configuration" className="flex flex-col gap-5 pt-4">
            <div className="flex flex-col gap-1.5 rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <Label>Allowed Domains</Label>
              <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Restrict which websites can embed your chat widget. Leave blank to allow all domains (not recommended for production).</p>
            ...
            <div className="flex items-center justify-between rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div>
                <div className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">Enable widget in mobile apps</div>
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Mobile apps don't send domain information, so allow this to avoid them being blocked.</p>
              </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#EEE7DD] dark:border-mcm-line p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink">Identity Validation</div>
                  <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Verify user authenticity with a signed HMAC token to prevent impersonation.</p>
                </div>
              ...
              {inbox.identity_validation_enabled && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <code className="flex-1 truncate rounded-lg border border-[#EEE7DD] dark:border-mcm-line bg-[#FBE2C8]/45 dark:bg-mcm-surface-3 px-3 py-2 text-xs text-[#9A948F] dark:text-mcm-ink-3">{inbox.identity_validation_secret}</code>
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    <div>
                      <div className="text-sm text-[#2E2D35] dark:text-mcm-ink">Require identity validation for all conversations</div>
                      <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Requests without a valid token are rejected.</p>
                    </div>
            ...
            {inbox.legacy_assistant_id ? (
              ...
              <>
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Pick which Captain assistant answers this inbox automatically. Choose "None" for a human-only inbox.</p>
        ...
        <div className="flex min-h-0 flex-col gap-3 rounded-2xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] p-3">
          <div className="flex items-center justify-between">
            <div className="flex gap-1 rounded-lg bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 p-0.5">
              <button
                type="button"
                onClick={() => setPreviewTab('preview')}
                className={`rounded-md px-2.5 py-1 text-xs font-medium ${previewTab === 'preview' ? 'bg-white dark:bg-mcm-surface-3 text-[#2E2D35] dark:text-mcm-ink shadow-sm' : 'text-[#9A948F] dark:text-mcm-ink-3'}`}
              >
                Preview
              </button>
              <button
                ...
                className={`rounded-md px-2.5 py-1 text-xs font-medium ${previewTab === 'script' ? 'bg-white dark:bg-mcm-surface-3 text-[#2E2D35] dark:text-mcm-ink shadow-sm' : 'text-[#9A948F] dark:text-mcm-ink-3'}`}
              >
                Script
              </button>
            </div>
          ...
          {previewTab === 'preview' ? (
            <>
              <div className="flex-1 overflow-hidden rounded-xl border border-gray-100 bg-[#FBE2C8]/45 dark:bg-mcm-surface-3">
                <iframe key={previewKey} src={previewUrl} title="Widget preview" className="h-full min-h-[420px] w-full border-0" />
              </div>
              <div className="flex items-center justify-between">
                <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Reflects your last saved settings.</p>
            ...
            <div className="flex flex-1 flex-col gap-2">
              <p className="text-xs text-[#9A948F] dark:text-mcm-ink-3">Paste this before the closing &lt;/body&gt; tag of any page you want this chatbot on.</p>
              <div className="flex items-start gap-2 rounded-xl border border-[#EEE7DD] dark:border-mcm-line bg-[#FBE2C8]/45 dark:bg-mcm-surface-3 p-3">
                <code className="flex-1 overflow-x-auto whitespace-pre text-xs text-[#2E2D35] dark:text-mcm-ink">{embedSnippet}</code>
                <button type="button" onClick={copySnippet} className="shrink-0 text-[#9A948F] dark:text-mcm-ink-3 hover:text-primary" title="Copy">
