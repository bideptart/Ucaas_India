      ...
      <Tabs defaultValue="all" className="w-full">
        <div className="border-b border-gray-200 w-full">
          <TabsList className=" w-full bg-white p-0 rounded-none">
            <TabsTrigger
              className="cursor-pointer font-semibold data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none  data-[state=active]:border-b-primary data-[state=active]:rounded-none border-b-2 h-full px-4 data-[state=inactive]:text-gray-700"
              value="all"
            >
              All
            </TabsTrigger>
