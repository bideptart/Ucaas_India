...
export const ChatFooter = ({
  ...
  const baseComposerClasses =
    'w-full flex flex-col border-none rounded-md min-h-[120px] pb-8 relative';
        ...
        <>
          ...
          {isRecording && !fromMeetChat && !isGuestRestrictedFooter && canUseFileUploadControls ? (
            ...
            <div className="relative shrink-0">
              ...
              <div className={baseComposerClasses} style={{ border: 'none', outline: 'none' }}>{renderComposerEditor()}</div>
