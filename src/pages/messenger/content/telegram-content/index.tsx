            ...
            <div className="flex flex-col relative justify-between w-full  gap-2.5 p-3 bg-white dark:bg-mcm-surface">
              <div className="relative w-full h-full flex gap-2 sm:gap-3 justify-between items-center">
                ...
                <div
                  ...
                  className="cursor-pointer flex items-center justify-center rounded-full w-[40px] min-w-[40px] h-[40px]  bg-primary text-white hover:bg-[#FBE2C8]/40 dark:hover:bg-mcm-surface-3 hover:text-[#2E2D35]/80 dark:hover:text-mcm-ink-2/80"
                >
