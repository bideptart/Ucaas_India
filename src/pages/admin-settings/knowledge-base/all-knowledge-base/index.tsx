    ...
    <section className="w-full flex flex-col overflow-x-auto overflow-y-hidden">
      <div className="flex  flex-col sm:flex-row items-center justify-between p-3 border-b border-[rgba(225,200,165,0.9)] dark:border-mcm-line min-h-[65px] bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px]">
        <div className="flex gap-2 items-center cursor-pointer" onClick={handleBackNavigation}>
          ...
          <h3 className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Add Knowledge Base</h3>
        </div>
      </div>
      <div className="w-full p-3 flex flex-col items-center gap-3 overflow-y-auto">
        <div className="w-full h-[calc(100vh-2rem)] max-w-[90%] flex items-center justify-center flex-col gap-3">
          <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-2xl">Add Knowledge Base</h4>
          <h5 className="text-[#2E2D35] dark:text-mcm-ink font-medium text-sm">
          ...
          >
            <div
              className="flex flex-col gap-3 items-center justify-center bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-xl p-4 border border-[rgba(225,200,165,0.9)] dark:border-mcm-line min-h-56 cursor-pointer"
              onClick={() =>
                setActions((prev) => ({
                  ...prev,
                  uploadPdfFile: true,
            ...
            >
              ...
              <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-md text-center">Upload PDF File</h4>
            ...
            >
              ...
              <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-md text-center"> Create Content</h4>
              <p className="text-[#9A948F] dark:text-mcm-ink-3 font-normal text-sm text-center">
            ...
            >
              ...
              <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-md text-center"> Get From URL</h4>
              <p className="text-[#9A948F] dark:text-mcm-ink-3 font-normal text-sm text-center">
