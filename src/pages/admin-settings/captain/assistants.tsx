  ...
  return (
    <div className="flex h-full w-full flex-col gap-5 p-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          <div className="text-lg font-bold text-[#2E2D35] dark:text-mcm-ink">Assistants</div>
          <div className="text-sm text-[#9A948F] dark:text-mcm-ink-3">
      ...
      <div className="flex-1 overflow-auto rounded-2xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px]">
        {isLoading ? (
          ...
          <div className="flex h-40 flex-col items-center justify-center gap-2 text-sm text-[#9A948F] dark:text-mcm-ink-3">
            <Sparkles className="size-6 text-gray-300 dark:text-mcm-ink-4" />
            No assistants yet.
          </div>
        ) : (
          <div className="divide-y divide-gray-100 dark:divide-mcm-line">
            {assistants.map((a) => (
              <div key={a.id} className="flex items-start justify-between gap-4 px-5 py-4 transition-colors hover:bg-[#FBE2C8]/45 dark:hover:bg-mcm-surface-3">
                <div className="flex flex-1 items-start gap-3">
                  <div className="mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Sparkles className="size-4" />
                  </div>
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[#2E2D35] dark:text-mcm-ink">{a.name}</div>
                    <div className="mt-0.5 text-sm text-[#9A948F] dark:text-mcm-ink-3">{a.description}</div>
                    <div className="mt-1 line-clamp-1 text-xs text-[#9A948F] dark:text-mcm-ink-3">{a.config?.instructions}</div>
                  </div>
                </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-h-[88vh] w-full max-w-2xl overflow-y-auto rounded-2xl p-0">
          <div className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-gray-100 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] px-6 py-4">
          ...
          <div className="flex flex-col gap-5 px-6 py-5">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3 rounded-xl border border-[#EEE7DD] dark:border-mcm-line bg-[#FBE2C8]/50 dark:bg-mcm-surface-3 p-4">
                {[
                  ...
                  <div key={feat.key} className="flex items-center gap-2.5">
                    ...
                    />
                    <Label htmlFor={feat.key} className="cursor-pointer text-sm font-normal text-[#2E2D35] dark:text-mcm-ink">
                      {feat.label}
                    </Label>
                  </div>
                ))}
            ...
            <div className="flex flex-col gap-1.5">
              <Label className="flex items-center gap-1.5">
                <Wrench className="size-3.5 text-[#9A948F] dark:text-mcm-ink-3" />
                Customer tools
              </Label>
              ...
              {!editingId ? (
                <div className="rounded-xl border border-dashed border-[#EEE7DD] dark:border-mcm-line bg-[#FBE2C8]/50 dark:bg-mcm-surface-3 px-4 py-3.5 text-sm text-[#9A948F] dark:text-mcm-ink-3">
                  Save this assistant first, then come back here to allow or block connected apps for it.
                </div>
              ) : isLoadingComposioAccess ? (
                <div className="flex h-14 items-center justify-center text-sm text-[#9A948F] dark:text-mcm-ink-3">Loading...</div>
                ...
                <div className="flex flex-col divide-y divide-gray-100 dark:divide-mcm-line rounded-xl border border-[#EEE7DD] dark:border-mcm-line">
                  {composioAccess.map((c) => (
                    <div key={c.toolkit_slug} className="flex items-center justify-between gap-3 px-4 py-2.5">
                      <span className="text-sm text-[#2E2D35] dark:text-mcm-ink">{c.toolkit_name}</span>
            ...
            <details className="group rounded-xl border border-[#EEE7DD] dark:border-mcm-line">
              <summary className="cursor-pointer list-none px-4 py-3 text-sm font-medium text-[#2E2D35] dark:text-mcm-ink select-none">
                Advanced — response guidelines &amp; guardrails
              </summary>
              <div className="flex flex-col gap-4 border-t border-gray-100 dark:border-mcm-line px-4 py-4">
                <div className="flex flex-col gap-1.5">
          ...
          <div className="sticky bottom-0 flex justify-end gap-2 border-t border-gray-100 bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] px-6 py-4">
