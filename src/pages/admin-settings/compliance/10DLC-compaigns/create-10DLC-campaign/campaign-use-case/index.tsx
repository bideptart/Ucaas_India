      ...
      <div className="w-full min-h-0 flex flex-col items-stretch gap-4 overflow-y-auto pr-1">
        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
            {/* STANDARD LIST */}
            <div className=" w-full border-1 border-ucass-primary-200 rounded-lg bg-white p-3 dark:bg-mcm-surface">
              <h3 className="flex items-center gap-1 justify-center text-sm font-medium text-primary mb-2">
                <Star className="w-4.5 h-4.5" />
                Standard Campaign Type
              </h3>

              <div className=" w-full border-gray-100 rounded-lg bg-gray-50 dark:border-mcm-line dark:bg-mcm-surface-3">
                <div className="p-3 rounded-t-xl bg-gray-100 flex items-center gap-2 dark:bg-mcm-surface-3">
                  <h3 className="text-gray-900 font-medium w-4/7 text-sm dark:text-mcm-ink">Use Case</h3>
                  <h3 className="text-gray-900 font-medium  w-3/7 text-sm dark:text-mcm-ink">TCR Monthly Fee</h3>
                </div>
                          ...
                          Object.entries(useCaseData).map((v) => {
                            ...
                            return (
                              <div className="w-full flex items-center gap-2" key={value}>
                                ...
                                <h3 className="shrink-0 whitespace-nowrap text-gray-500 font-medium text-sm dark:text-mcm-ink-3">
                                  $20
                                </h3>
                              </div>
                            );
            ...
            <div className=" w-full  border-1  border-ucass-primary-200 rounded-lg bg-white p-3 dark:bg-mcm-surface">
              ...
              <div className=" w-full  border-1  border-gray-100 rounded-lg bg-gray-50 dark:border-mcm-line dark:bg-mcm-surface-3">
                <div className="p-3 rounded-t-xl bg-gray-100 flex items-center gap-2 dark:bg-mcm-surface-3">
                  <h3 className="text-gray-900 font-medium w-4/7 text-sm dark:text-mcm-ink">Use Case</h3>
                  <h3 className="text-gray-900 font-medium  w-3/7 text-sm dark:text-mcm-ink">TCR Monthly Fee</h3>
                </div>
