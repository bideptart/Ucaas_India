  ...
  if (!conversations.length) {
    return (
      <div className="flex flex-col items-center justify-center gap-2 h-full text-center p-6">
        ...
        <p className="text-sm text-gray-500 dark:text-mcm-ink-3">No website conversations yet</p>
      </div>
    );
  }
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-[11px] text-gray-400 dark:text-mcm-ink-3 shrink-0">{moment(c.lastMessageAt).fromNow()}</span>
              </div>
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <span className="text-xs text-gray-400 dark:text-mcm-ink-3 truncate">{c.inboxName || 'Website'}</span>
              </div>
            </div>
          </button>
        );
