...
const MeetingInfo = ({ meetState }: { meetState: any }) => {
  ...
  return (
    <div className="bg-white dark:bg-mcm-surface rounded-xl absolute bottom-20 px-4 pt-4 pb-5 flex flex-col items-center w-[360px]">
      <div className="flex flex-col gap-1">
        <small className="text-gray-700 dark:text-mcm-ink-3">Meeting details</small>
        <h5 className="text-primary-800 font-bold">UCAAS Meeting</h5>
        <div className="flex flex-col pt-2 gap-1.5">
          <div className="flex gap-3">
            <small className="text-gray-900 dark:text-mcm-ink font-semibold w-1/4">Host</small>
            <small className="font-medium w-3/4 break-words">
              {hostName || meetState?.hostName || 'Unknown'}
            </small>
          </div>
          <div className="flex gap-3">
            <small className="text-gray-900 dark:text-mcm-ink font-semibold w-1/4">Meeting ID</small>
            <small className="font-medium w-3/4 break-words">
              {meetState?.meetUniqueKey ?? ''}
            </small>
          </div>
          <div className="flex gap-3">
            <small className="text-gray-900 dark:text-mcm-ink font-semibold w-1/4">Meeting Link</small>
      ...
      <div className="absolute polygon w-5 h-5 bg-white dark:bg-mcm-surface bottom-[-10px] left-4"></div>
    </div>
  );
};
