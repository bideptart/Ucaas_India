...
const IndividualAssignNumber = ({ rowData, handleClose }: any) => {
  ...
  return (
    ...
    >
            ...
            <section className="flex min-h-0 w-full overflow-x-auto overflow-y-visible">
              <div className="flex w-full min-w-0 flex-col gap-4">
                <div className="flex w-full min-w-0 gap-3">
                  <div className="flex w-full min-w-0 flex-col gap-4">
                    {isShowTable ? (
                      <div className="relative w-full overflow-x-auto rounded-xl bg-white p-2 sm:p-3 dark:bg-mcm-surface">
                          ...
                          <div className="flex w-full flex-wrap gap-4">
                            {watchCity?.value && watchState?.value ? (
                              didAvailableLoading ? (
                                ...
                                <div className="flex w-full flex-col gap-3 rounded-xl border border-[rgba(225,200,165,0.9)] bg-[rgba(251,249,246,0.88)] backdrop-blur-[12px] p-3 sm:items-center dark:border-mcm-line dark:bg-mcm-surface">
                                  ...
                                  >
                                    {didAvailableData?.slice(0, 10)?.map((item: any) => {
                                      ...
                                      return (
                                        <div
                                          className="flex min-w-0 items-start gap-2 rounded-lg border border-[#EEE7DD] px-3 py-2 sm:items-center dark:border-mcm-line"
                                          key={`${didId}-${didNumber}`}
                                        >
                                ...
                                <div className="w-full">
                                  <div className="flex w-full flex-col items-center gap-3 rounded-xl border border-[rgba(225,200,165,0.9)] bg-[rgba(251,249,246,0.88)] backdrop-blur-[12px] p-3 text-center dark:border-mcm-line dark:bg-mcm-surface">
                              ...
                              <h5 className="flex w-full justify-center py-2 text-center text-base font-normal text-[#2E2D35] dark:text-mcm-ink-2">
      ...
      <div className="flex shrink-0 flex-row gap-2 border-t border-[rgba(225,200,165,0.9)] bg-[rgba(251,249,246,0.88)] backdrop-blur-[12px] pt-3 dark:border-mcm-line dark:bg-mcm-surface">
        <Button
          variant={'transparent'}
          type="button"
          onClick={handleClose}
