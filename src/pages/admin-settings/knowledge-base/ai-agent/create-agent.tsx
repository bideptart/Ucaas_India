  ...
  return (
    <section className="w-full flex flex-col gap-3">
      ...
      <div className="w-full h-full p-3 flex flex-col gap-3">
        {instantStep === 'none' && (
          <div className="w-full lg:max-w-[75%] xxl:max-w-[60%] h-full mx-auto flex items-center justify-center flex-col gap-3">
            <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-lg">
              How would you like to build your Chat AI agent?
            </h4>
            <p className="text-[#9A948F] dark:text-mcm-ink-3 text-sm text-center max-w-150">
            ...
            <div className="flex gap-4 w-full">
              <div
                className="flex flex-col gap-3 items-start justify-center bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-xl px-6  border border-[rgba(225,200,165,0.9)] dark:border-mcm-line cursor-pointer w-full hover:border-primary transition-colors duration-200 group"
                onClick={() => {
                  setHasWebsite(true);
                  setInstantStep('website');
                }}
              >
                ...
                <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-md">Instant Agent</h4>
                <p className="text-[#9A948F] dark:text-mcm-ink-3 font-normal text-sm">
              ...
              {active === 'chat' ? (
                <div className="w-full flex flex-col gap-3 max-w-80">
                  <div
                    className="flex flex-col gap-3 items-start justify-center bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-xl p-4 py-6 border border-[rgba(225,200,165,0.9)] dark:border-mcm-line cursor-pointer w-full hover:border-primary transition-colors duration-200 group"
                    onClick={() =>
                      navigate('/admin-settings/knowledge/create-agent', {
                  ...
                  >
                    ...
                    <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-md text-center">
                      Start From Scratch
                    </h4>
                    <p className="text-[#9A948F] dark:text-mcm-ink-3 font-normal text-sm">
                  ...
                  >
                    ...
                    <h4 className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-md">Use a Template</h4>
                    <p className="text-[#9A948F] dark:text-mcm-ink-3 font-normal text-sm">
                ...
                <div className="w-full flex items-center justify-center gap-3">
                  <div
                    className="flex flex-col gap-3 items-center justify-center bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-xl p-4 border border-[rgba(225,200,165,0.9)] dark:border-mcm-line w-1/3 min-h-56 cursor-pointer hover:border-primary transition-colors duration-200 group"
                    onClick={() =>
                      navigate('/admin-settings/knowledge/create-agent', {
                  ...
                  >
                    ...
                    <p className="text-[#9A948F] dark:text-mcm-ink-3 font-normal text-sm text-center">
        ...
        {instantStep === 'website' && (
          <div className="w-full h-full mx-auto max-w-[75%] flex items-center justify-center">
            <div className="w-full max-w-225 flex flex-col items-center justify-center gap-4">
              ...
              <h3 className="text-[#2E2D35] dark:text-mcm-ink text-xl font-semibold text-center">
                Accelerate Training with Your Website
              </h3>
              <p className="text-[#9A948F] dark:text-mcm-ink-3 text-center text-sm max-w-187.5">
              ...
              <h4 className="text-[#2E2D35] dark:text-mcm-ink text-xl font-semibold text-center">
                ...
                <button
                  ...
                  className={`relative min-h-62 rounded-2xl border p-8 flex flex-col items-center justify-center gap-4 cursor-pointer transition-colors ${
                    hasWebsite
                      ...
                      : 'border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] hover:border-[rgba(225,200,165,0.9)] dark:hover:border-mcm-line'
                  }`}
                >
                  <span
                    className={`absolute top-4 right-4 w-5 h-5 rounded-full border flex items-center justify-center ${
                      hasWebsite ? 'border-primary text-primary' : 'border-[#EEE7DD] dark:border-mcm-line text-gray-300'
                    }`}
                  >
                  ...
                  <span
                    className={`w-14 h-14 rounded-full flex items-center justify-center ${
                      hasWebsite ? 'bg-primary text-white' : 'bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3'
                    }`}
                  >
                    <Check className="w-7 h-7" />
                  </span>
                  <p className="text-[#2E2D35] dark:text-mcm-ink text-base text-center font-medium">
        ...
        {instantStep === 'pdf' && (
          <div className="w-full h-full mx-auto max-w-[75%] flex items-center justify-center">
            <div className="w-full max-w-225 flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-[#9A948F] dark:text-mcm-ink-3 text-center text-sm  max-w-125">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-175 mt-3">
                ...
                >
                  <span
                    className={`absolute top-4 right-4 w-5 h-5 rounded-full border flex items-center justify-center ${
                      hasPdf ? 'border-primary text-primary' : 'border-[#EEE7DD] dark:border-mcm-line text-gray-300'
                    }`}
                  >
                  ...
                  <span
                    className={`w-14 h-14 rounded-full flex items-center justify-center ${
                      hasPdf ? 'bg-primary text-white' : 'bg-[#FBE2C8]/40 dark:bg-mcm-surface-3 text-[#9A948F] dark:text-mcm-ink-3'
                    }`}
                  >
                    <Check className="w-7 h-7" />
                  </span>
        ...
        {instantStep === 'custom-content' && (
          <div className="w-full h-full mx-auto max-w-[90%] flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-[#2E2D35] dark:text-mcm-ink text-xl font-semibold">Create Custom Content</h3>
                <p className="text-[#9A948F] dark:text-mcm-ink-3 text-sm mt-1">
            ...
            <div className="w-full bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-2xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line min-h-[calc(100vh-321px)] max-h-[calc(100vh-321px)] overflow-hidden flex flex-col">
              <div className="px-5 py-3 border-b border-[#EEE7DD] dark:border-mcm-line text-[#2E2D35] dark:text-mcm-ink text-sm font-semibold bg-[#FBE2C8]/45 dark:bg-mcm-surface-3 flex items-center gap-2">
                <TypeIcon width={16} height={16} /> CONTENT EDITOR
              </div>
              <textarea
                value={customContent}
                onChange={(e) => setCustomContent(e?.target?.value || '')}
                className="w-full flex-1 p-6 text-base text-[#2E2D35] dark:text-mcm-ink outline-none resize-none"
      ...
      {isSummaryModalOpen && (
        ...
        >
          <DialogContent
            className="w-[95vw] max-w-[1100px] h-[90vh] p-0 overflow-hidden border-[#EEE7DD] dark:border-mcm-line"
            showCloseButton={false}
          >
            <div className="w-full h-full flex flex-col bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px]">
              <div className="px-6 py-4 border-b border-[#EEE7DD] dark:border-mcm-line">
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="text-lg text-[#2E2D35] dark:text-mcm-ink font-semibold">Curated Content Summary</h4>
                    <p className="text-sm text-[#9A948F] dark:text-mcm-ink-3 mt-1">
                  ...
                  <button
                    type="button"
                    className="text-[#9A948F] dark:text-mcm-ink-3 hover:text-[#9A948F] dark:hover:text-mcm-ink-3 cursor-pointer"
              ...
              <div className="px-6 py-4 flex-1 overflow-y-auto bg-[#FBE2C8]/45 dark:bg-mcm-surface-3 max-h-[calc(100vh-230px)] overflow-auto">
                <div className="w-fit mx-auto mb-5 border border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-xl p-1 flex items-center gap-1">
                  <button
                    type="button"
                    onClick={() => setSummaryTab('descriptive')}
                    className={`px-6 py-2 rounded-lg text-sm md:text-base ${
                      summaryTab === 'descriptive'
                        ? 'border border-gray-900 dark:border-mcm-ink-2 text-[#2E2D35] dark:text-mcm-ink'
                ...
                {summaryTab === 'descriptive' ? (
                  <div className="bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-2xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line p-6">
                    <h5 className="text-xl font-semibold text-[#2E2D35] dark:text-mcm-ink mb-1">Business Overview</h5>
                    <p className="text-base  text-[#9A948F] dark:text-mcm-ink-3 leading-7">{summaryParagraph}</p>

                    <h6 className="text-sm font-medium text-[#2E2D35] dark:text-mcm-ink mt-6 min-h-7">
                      Key Extracted Highlights
                    </h6>
                    <div className="space-y-3 border-t border-[#EEE7DD] dark:border-mcm-line pt-4">
                      {highlightLines.map((line, index) => (
                        <div key={`${line}-${index}`} className="flex gap-3 text-sm  text-[#2E2D35] dark:text-mcm-ink">
                  ...
                  <div className="bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] rounded-2xl border border-[rgba(225,200,165,0.9)] dark:border-mcm-line p-6 space-y-5 ">
                    <div className="flex justify-between items-center gap-4 w-full mb-8">
                      <h6 className="text-xl font-bold text-[#2E2D35] dark:text-mcm-ink">Learned Knowledge (FAQs)</h6>
                      <Button type="button" variant="outline">
                        <PlusIcon width={18} height={18} /> Add Manual Entry
                      </Button>
                    </div>
                    {faqItems.map((item, index) => (
                      <div className="flex justify-between items-start gap-4 border-t border-[#EEE7DD] dark:border-mcm-line pt-4">
                        <div key={`${item.q}-${index}`} className="w-full flex flex-col">
                          <h6 className="text-base  text-[#2E2D35] dark:text-mcm-ink font-semibold">{item.q}</h6>
                          <p className="text-sm text-[#9A948F] dark:text-mcm-ink-3 mt-2">{item.a}</p>
                        </div>
              ...
              <div className="px-6 py-4 border-t border-[#EEE7DD] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] flex items-center justify-between">
                <Button
                  type="button"
                  className="min-w-24"
                  variant="outline"
      ...
      {isUrlModalOpen && (
        <Dialog open={isUrlModalOpen} onOpenChange={(val) => (!val ? closeUrlModal() : null)}>
          <DialogContent
            className="w-[600px] max-w-[95vw] p-0 overflow-hidden border-[#EEE7DD] dark:border-mcm-line"
            showCloseButton={false}
          >
            {urlModalStep === 'input' && (
              <div className="p-6 flex flex-col gap-4">
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="text-lg text-[#2E2D35] dark:text-mcm-ink font-semibold">Get from URL</h4>
                    <p className="text-sm text-[#9A948F] dark:text-mcm-ink-3 mt-1">
            ...
            {(urlModalStep === 'discovering' || urlModalStep === 'discovered') && (
              <div className="flex flex-col h-[620px]">
                <div className="p-6 pb-4 border-b border-[#EEE7DD] dark:border-mcm-line">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-lg text-[#2E2D35] dark:text-mcm-ink font-semibold">Discovered Sitemap</h4>
                      <p className="text-sm text-[#9A948F] dark:text-mcm-ink-3 mt-1">
                ...
                {urlModalStep === 'discovering' || isDiscovering ? (
                  <div className="flex-1 bg-[#FBE2C8]/45 dark:bg-mcm-surface-3 flex flex-col items-center justify-center gap-4">
                    ...
                    <h5 className="text-lg text-[#2E2D35] dark:text-mcm-ink font-medium">
                      Discovering website links...
                    </h5>
                    <p className="text-sm text-[#9A948F] dark:text-mcm-ink-3">Scanning the URL for available pages</p>
                  </div>
                ) : (
                  <>
                    <div className="px-6 py-3 border-b border-[rgba(225,200,165,0.9)] dark:border-mcm-line bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px]">
                      <div className="flex items-center gap-2 text-[#2E2D35] dark:text-mcm-ink">
                    ...
                    <div className="flex-1 bg-[#FBE2C8]/45 dark:bg-mcm-surface-3 p-4 overflow-y-auto">
                      <div className="bg-[rgba(251,249,246,0.88)] dark:bg-mcm-surface backdrop-blur-[12px] border border-[rgba(225,200,165,0.9)] dark:border-mcm-line rounded-xl overflow-hidden">
                            ...
                            <div
                              ...
                              className={`px-4 py-4 flex items-center gap-3 ${
                                index !== filteredDiscoveredLinks.length - 1
                                  ? 'border-b border-[#EEE7DD] dark:border-mcm-line'
                                  : ''
                              }`}
                            >
                              <Checkbox
                              ...
                              />
                              <span className="text-[#2E2D35] dark:text-mcm-ink text-sm break-all">
                                [{link}]({link})
                              </span>
                            </div>
                          ))
                        ) : (
                          <div className="px-4 py-10 text-sm text-[#9A948F] dark:text-mcm-ink-3 text-center">
