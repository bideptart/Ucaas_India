        ...
        <div className="flex flex-col gap-4 border-b border-gray-200 dark:border-mcm-line">
          <div className="overflow-auto table-scroll">
            <Table className="w-full text-sm text-gray-700 dark:text-mcm-ink-2 h-full border border-gray-200 dark:border-mcm-line">
              <TableHeader className="text-gray-900/80 dark:text-mcm-ink-2">
                <TableRow>
                  <TableHead
                    className={`px-4 py-2 border-b border-r border-gray-200 dark:border-mcm-line last-of-type:border-r-0 text-gray-900/80 dark:text-mcm-ink-2 font-semibold`}
                  >
                    Billing Period
                  </TableHead>
                  <TableHead
              ...
              <TableBody className="divide-y divide-gray-200 dark:divide-mcm-line bg-white dark:bg-mcm-surface-3 h-full w-full font-normal">
                {data?.virtualNumbers?.length > 0 ? (
                  data?.virtualNumbers?.map((item: any) => {
                    ...
                    return (
                      <TableRow key={`${name}-${value}`}>
                        ...
                        <td className="bg-gray-100/10 dark:bg-mcm-surface-3/40 border-b border-gray font-medium px-4 py-3 text-gray-900 dark:text-mcm-ink text-left">
                          <p className="font-medium text-gray-800 dark:text-mcm-ink-2">
                  ...
                  <TableRow>
                    ...
                    <td className="bg-gray-100/10 dark:bg-mcm-surface-3/40 border-b border-gray font-medium px-4 py-3 text-gray-900 dark:text-mcm-ink text-left">
                      <p className="font-medium text-gray-800 dark:text-mcm-ink-2">${billingDetails?.prorated_cost}</p>
                    </td>
                  </TableRow>
                )}
              </TableBody>
