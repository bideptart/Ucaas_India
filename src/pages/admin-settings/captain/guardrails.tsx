  ...
  return (
    <div className="flex h-full w-full flex-col gap-6 overflow-y-auto p-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">Guardrails</h1>
      </div>

      <div className="max-w-3xl">
        {/* Description */}
        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
          Keeps things on track — only the kinds of questions you want your assistant to answer, nothing off-limits or off-topic.
        </p>
          ...
          <div className="mb-6 rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
            <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
              <div className="flex items-center gap-4">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Example guardrails</span>
                <button
                  type="button"
        ...
        {items.length === 0 && !adding ? (
          <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">No guardrails found. Create or add examples to begin.</p>
        ) : (
