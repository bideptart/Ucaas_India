...
const InviteParticipants = ({
  ...
  return (
    <>
      {!isDirectModal && (
        <div className="bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(30,41,59,0.92)] backdrop-blur-[12px] rounded-xl absolute bottom-20 px-4 pt-4 pb-5 flex flex-col items-center w-[530px] shadow-lg border border-[rgba(225,200,165,0.9)] dark:border-[rgba(71,85,105,0.9)]">
          <div className="flex flex-col gap-1">
            <small className="text-[#2E2D35] dark:text-[#f8fafc]">Invite Participants</small>
            ...
            <div className="flex flex-col pt-2 gap-1.5">
              <div className="flex flex-col">
                ...
                <div className="flex items-center justify-between">
                  <small
                    className="text-[#2E2D35] dark:text-[#f8fafc] font-semibold"
                    id="text-to-copy"
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <small className="text-[#2E2D35] dark:text-[#f8fafc] font-semibold">
