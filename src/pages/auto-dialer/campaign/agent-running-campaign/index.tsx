    ...
    <>
      {waitingState && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white dark:bg-mcm-surface rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 animate-in fade-in zoom-in duration-300">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="relative">
                ...
                <svg className="absolute inset-0 w-24 h-24 -rotate-90">
                  <circle
                    ...
                    strokeWidth="4"
                    fill="none"
                    className="text-[#F0DFC5] dark:text-[#334155]"
                  />
                  <circle
                    cx="48"
                    cy="48"
              ...
              <div className="text-center space-y-3">
                <h3 className="text-2xl font-bold text-[#2E2D35] dark:text-mcm-ink">Please Wait</h3>
                <p className="text-[#9A948F] dark:text-mcm-ink-3 text-lg">Wait till waiting time completes</p>
              ...
              <div className="w-full max-w-xs space-y-2">
                <div className="flex justify-between text-sm text-[#9A948F] dark:text-mcm-ink-3">
                  <span>Progress</span>
                  <span className="font-semibold text-primary">{Math.round(waitingProgress)}%</span>
                </div>
                <div className="h-3 bg-[#F0DFC5] dark:bg-[#334155] rounded-full overflow-hidden">
                  <div
      ...
      <section className="w-full bg-muted/40 flex flex-col overflow-x-auto overflow-y-hidden  h-full">
        <div className="flex items-center justify-between p-3 border-b border-[rgba(225,200,165,0.9)] dark:border-[rgba(100,116,139,0.3)] min-h-[65px] bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(15,23,42,0.88)] backdrop-blur-[12px]">
          <p className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-lg flex items-center gap-1">
        ...
        <div className="p-3 w-full h-full relative overflow-hidden">
          <div className="bg-white dark:bg-mcm-surface w-full rounded-xl p-3 flex gap-3  h-[calc(100vh-9.5rem)] overflow-y-auto">
            ...
            {isWaitingMoreCampaignCall && (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center bg-white dark:bg-mcm-surface rounded-xl p-4">
                <div className="flex flex-col items-center gap-6 max-w-lg w-full">
                  ...
                  <div className="text-center space-y-2">
                    <h3 className="text-2xl font-bold text-[#2E2D35] dark:text-mcm-ink">Waiting for Next Call</h3>
                    <p className="text-[#9A948F] dark:text-mcm-ink-3 text-base">
            ...
            {!isWaitingMoreCampaignCall && (
              <>
                {
                  <div className="w-full max-w-[22rem]  border-r border-[#EEE7DD] dark:border-mcm-line  pr-3 h-full overflow-y-auto">
                    {/* dialer space */}
                    {/* <CommonDialerWidget
                ...
                <div className="w-full h-full ">
                  ...
                  {selectedContact?._id ? (
                    ...
                    >
                      <div className="border-b border-[#EEE7DD] dark:border-mcm-line w-full">
                        <TabsList className="flex text-sm font-semibold text-center  p-0 rounded-none min-h-10 ">
                          {selectedCampaign?.agentScripting && (
                            <TabsTrigger
                              ...
                              className="data-[state=active]:border-b-2 data-[state=active]:border-b-primary data-[state=active]:text-primary border-b-2 px-6   text-[#2E2D35] dark:text-mcm-ink-2 cursor-pointer h-full rounded-none    m-auto relative flex gap-1 bg-transparent font-semibold data-[state=active]:shadow-2xs"
                            >
                      ...
                      <TabsContent value={RUNNING_CAMPAIGN_TAB_CONST.INFO}>
                        <div className="w-full">
                          <div className="w-full flex flex-col gap-2">
                            ...
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Dial Number :</span>{' '}
                              {selectedContact?.contacts?.[0]?.phone || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Email :</span>{' '}
                              {selectedContact?.contacts?.[0]?.email || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Job title :</span>{' '}
                              {selectedContact?.contacts?.[0]?.title || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Industry :</span>{' '}
                              {selectedContact?.contacts?.[0]?.industry || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Facebook :</span>{' '}
                              {selectedContact?.contacts?.[0]?.facebook || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Twitter :</span>{' '}
                              {selectedContact?.contacts?.[0]?.twitter || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">City :</span>{' '}
                              {selectedContact?.contacts?.[0]?.city || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">State :</span>{' '}
                              {selectedContact?.contacts?.[0]?.state || ''}
                            </p>
                            <p className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                              <span className="font-semibold text-[#2E2D35] dark:text-mcm-ink">Country :</span>{' '}
                      ...
                      <TabsContent value={RUNNING_CAMPAIGN_TAB_CONST.DISPOSITION}>
                        <div className="w-full flex flex-col gap-2">
                          ...
                          <div className="flex gap-3 w-full h-full">
                            <div className="w-1/2 p-3 border rounded-xl border-[#EEE7DD] dark:border-mcm-line">
                              <NotesWidget
                                contactId={selectedContact?.contactId}
                                sipCallId={activeCallSessionData?._callID}
                                extraPayload={{
                            ...
                            <div className="w-1/2  p-3 flex flex-col gap-2  border rounded-xl border-[#EEE7DD] dark:border-mcm-line">
                              <div className="flex flex-col gap-2">
                                <p className="text-[#2E2D35] dark:text-mcm-ink font-semibold text-base flex items-center gap-1 mb-1">
                                  Reschedule Call
                                </p>
                                <div className="flex items-center gap-3 w-full">
                                  ...
                                  {isCustomSchedule && (
                                    <DatePicker
                                      ...
                                      className="border border-gray-300 dark:border-mcm-line focus:border-primary focus:ring-0
           focus:outline-none shadow-secondary/5
           disabled:bg-gray-300 dark:disabled:bg-mcm-surface-3 disabled:text-slate-500
           disabled:border-[#EEE7DD] dark:disabled:border-mcm-line disabled:shadow-none
           text-[#2E2D35] dark:text-mcm-ink placeholder:text-[#2E2D35] dark:placeholder:text-mcm-ink-3
           bg-white dark:bg-mcm-surface shadow-sm text-sm hover:border-primary
           rounded-xl w-full px-3 min-h-10 custom-className"
                                  ...
                                  <div className="w-full  grid grid-cols-2 gap-2">
                                    {selectedCampaign?.agentDisposition?.map(
                                      (item: any, index: number) => (
                                        <div
                                          className="w-full flex items-center gap-2 border border-[#EEE7DD] dark:border-mcm-line p-3 rounded-md "
                                          key={index}
                                        >
                                          <RadioGroup
                    ...
                    <div className="w-full h-full flex flex-col gap-4 items-center justify-center">
                      ...
                      <div className="flex flex-col gap-2 items-center text-center">
                        <h3 className="text-lg font-semibold text-[#2E2D35] dark:text-mcm-ink">
                      ...
                      <Popover open={showPresence} onOpenChange={setShowPresence}>
                        <PopoverTrigger asChild>
                          <button className="cursor-pointer flex gap-2 items-center border rounded-md px-3 py-1.5 text-sm bg-white dark:bg-mcm-surface hover:bg-[#FBE2C8]/45 dark:hover:bg-[#334155]/45">
                            <div>
                              {statusImageLookup[user?.socket_status] ??
                                statusImageLookup['online']}
                            </div>
                            <div className="capitalize text-[#2E2D35] dark:text-mcm-ink">{user?.socket_status}</div>
                          </button>
                        </PopoverTrigger>
                            ...
                            return (
                              <div
                                ...
                                className={`flex items-center gap-2 w-full cursor-pointer px-2 rounded-md ${
                                  isActive
                                    ...
                                    : 'hover:bg-[#F0DFC5] dark:hover:bg-[#334155]'
                                }`}
                                onClick={() => {
                              ...
                              >
                                ...
                                <div className="p-2">
                                  ...
                                  <div className="text-xs text-[#9A948F] dark:text-mcm-ink-3">{status.description}</div>
                                </div>
                              </div>
                            );
                          })}
                ...
                {selectedCampaign?.dialMethod !== DIALER_TYPE.PREDICTIVE ? (
                  <div
                    className={`w-full max-w-[22rem] bg-[rgba(251,249,246,0.88)] dark:bg-[rgba(15,23,42,0.88)] backdrop-blur-[12px] transition-all ease-in-out duration-200 border border-[rgba(225,200,165,0.9)] dark:border-[rgba(100,116,139,0.3)] p-2 rounded-lg rounded-tl-none flex flex-col gap-3 absolute top-6 ${collapsed ? '-right-90.5' : 'right-6'} `}
                  >
                    <button
                    ...
                    >
                      ...
                      {selectedCampaign?.dialMethod === DIALER_TYPE.NORMAL ? (
                        <>
                          <div className="w-full flex flex-col gap-2">
                            <h3 className="text-base font-semibold text-[#2E2D35] dark:text-mcm-ink">Ongoing Lead</h3>
                            <div
                            ...
                            <Accordion
                              className="rounded-md border border-[#EEE7DD] dark:border-mcm-line p-1"
                              type="single"
                              value={activeItem}
                              onValueChange={(v) => {
                            ...
                            >
                              <AccordionItem value={selectedContact?._id}>
                                <AccordionTrigger
                                  variant="default"
                                  className="p-2 bg-[#FBE2C8]/45 dark:bg-[#334155]/45 rounded-md hover:no-underline font-semibold"
                                >
                                  Contact Details
                                </AccordionTrigger>
                          ...
                          <div>
                            <div className="w-full flex flex-col gap-2">
                              {contacts?.length > 0 && (
                                <h3 className="text-base font-semibold text-[#2E2D35] dark:text-mcm-ink">
                                  Leads in queue
                                </h3>
                              )}
                              ...
                              {contacts && contacts?.length ? (
                                ...
                                <div className="w-full flex items-center justify-center h-full">
                                  <h5 className="text-[#2E2D35] text-sm dark:text-mcm-ink">
                                            ...
                                            {selectedCampaign?.allowSkipping && (
                                              <CustomTooltip text="Skip Contact" side="top">
                                                ...
                                                >
                                                  <Icon
                                                    name="SkipIcon"
                                                    className="w-5 h-5 text-[#9A948F] dark:text-mcm-ink-3"
                                                  />
                                                </span>
                                              </CustomTooltip>
                                            )}
