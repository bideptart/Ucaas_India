...
const FolderList = ({
  ...
  return (
    <div className="w-full flex flex-col h-full bg-[var(--color-bg-gray-50)] overflow-hidden">
      <div className="w-full shrink-0 px-4 bg-white dark:bg-mcm-surface flex items-center justify-between border-b min-h-[56px] lg:min-h-[65px] border-b-gray-200">
        <div
        ...
        <div className="flex gap-3 items-center">
          {chatAccess?.create_folder && (
            ...
            >
              <div
                className="cursor-pointer flex items-center justify-center rounded-full w-9 h-9 bg-gray-100 dark:bg-mcm-surface-3 text-gray-900/80 dark:text-mcm-ink/80 hover:bg-primary hover:text-white"
                onClick={() => {
                  if (getObjectLength(selectedFolder)) {
                  ...
                  {displayFiles?.map((row: any) => {
                    ...
                    return (
                      <div
                        ...
                        className="group border border-gray-200 dark:border-mcm-line p-3.5 flex items-start gap-3 rounded-xl cursor-pointer hover:border-ucass-active-bg hover:shadow-[0_4px_16px_rgba(15,23,42,0.08)] transition-all bg-white dark:bg-mcm-surface"
                      >
                        <div className="flex flex-row items-start gap-2.5 flex-1 min-w-0">
                          <div className="w-9 h-9 flex items-center justify-center rounded-lg border border-gray-200 dark:border-mcm-line bg-gray-50 dark:bg-mcm-surface-3 shrink-0">
                            <FileIconRender type={extension} />
                          </div>

                          <div className="flex flex-col justify-between text-sm flex-1 min-w-0">
                            <div className="flex flex-col">
                              <p className="font-semibold text-gray-900 dark:text-mcm-ink truncate max-w-[200px]">
                                {file?.name || ''}
                              </p>
                              <p className="text-gray-800 dark:text-mcm-ink-2 truncate">
                            ...
                            <div
                              ...
                              className={`cursor-pointer flex items-center justify-center rounded-full w-7 h-7 border transition-colors ${
                                isFilePinned(file)
                                  ...
                                  : 'bg-gray-50 dark:bg-mcm-surface-3 border-gray-200 dark:border-mcm-line text-gray-500 dark:text-mcm-ink-3 hover:bg-gray-100 dark:hover:bg-mcm-surface-3 hover:text-gray-700 dark:hover:text-mcm-ink-2'
                              }`}
                            >
              ...
              {sortedFolders?.map((v: any) => {
                ...
                return (
                  <div
                    ...
                    className="group border border-gray-200 dark:border-mcm-line p-3.5 flex gap-3 rounded-xl cursor-pointer hover:border-ucass-active-bg hover:shadow-[0_4px_16px_rgba(15,23,42,0.08)] justify-between items-start bg-white dark:bg-mcm-surface transition-all"
                    onClick={() => {
                      setSelectedFolder(v);
                      setTimeout(() => {
                  ...
                  >
                    <div className="flex-col flex-1 min-w-0">
                      <div className="flex items-start gap-2">
                        <div className="mt-0.5 text-gray-700 dark:text-mcm-ink-2 w-9 h-9 rounded-lg border border-gray-200 dark:border-mcm-line bg-gray-50 dark:bg-mcm-surface-3 flex items-center justify-center shrink-0">
                          <Folder className="w-5 h-5 text-gray-500 dark:text-mcm-ink-3" />
                        </div>
                        <div className="flex flex-col overflow-hidden">
                          <h3 className="text-sm font-semibold text-gray-900 dark:text-mcm-ink truncate">
                            {folderName || ''}
                          </h3>
                          <span className="text-[11px] text-gray-500 dark:text-mcm-ink-3 truncate mt-0.5">
